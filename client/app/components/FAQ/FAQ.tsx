...
const FAQ = (props: Props) => {
  ...
  useEffect(() => {
    if (data) {
      ...
      // open first question by default so the panel isn't empty
  ...
  return (
    <section className="w-[90%] 800px:w-[80%] mx-auto ">
      ...
      {/* Two column layout */}
      <div className="grid 1000px:grid-cols-[1fr_1.2fr] gap-8 items-start">
        {/* Left — question list */}
        ...
        <div className="sticky top-24">
          {activeQ ? (
            <div className="rounded-2xl border border-gray-200 dark:border-white/10 bg-white dark:bg-slate-800 overflow-hidden shadow-sm">
              {/* Teal top bar */}
              <div className="h-1 w-full bg-teal-500" />

              <div className="p-8">
                {/* Question */}
                <h3 className="text-lg font-semibold text-gray-900 dark:text-white font-Poppins leading-snug mb-6">
                  {activeQ.question}
                </h3>
                ...
                {/* Answer */}
                <p className="text-base text-gray-600 dark:text-gray-300 font-Poppins leading-relaxed">
                  {activeQ.answer}
                </p>

                {/* Footer hint */}
                <div className="mt-8 pt-6 border-t border-gray-100 dark:border-white/10 flex items-center gap-3">
            ...
            <div className="rounded-2xl border border-dashed border-gray-200 dark:border-white/10 p-12 flex flex-col items-center justify-center text-center">
