...
const Courses = (props: Props) => {
  ...
  return (
    <section className="w-[92%] sm:w-[90%] 800px:w-[80%] mx-auto pb-14 sm:pb-20">
      {/* Heading */}
      <div className="text-center max-w-xl mx-auto px-2 sm:px-0">
        ...
        <h2 className="mt-3 sm:mt-4 text-[28px] leading-[38px] sm:text-4xl 1000px:text-5xl font-semibold 1000px:leading-tight text-gray-900 dark:text-white font-Poppins">
          Expand Your Career <span className="text-teal-500">Opportunity</span>
          <br />
          With Our Courses
        </h2>

        <p className="mt-4 sm:mt-5 text-sm sm:text-base text-gray-600 dark:text-gray-300 font-Poppins leading-[24px] sm:leading-relaxed">
      ...
      {/* Divider */}
      <div className="flex items-center gap-3 sm:gap-4 mt-10 sm:mt-12 mb-8 sm:mb-10">
        <div className="flex-1 h-px bg-gray-200 dark:bg-white/10" />

        <span className="text-[10px] sm:text-xs font-medium tracking-widest uppercase text-gray-400 dark:text-gray-500 whitespace-nowrap">
          {courses.length > 0
