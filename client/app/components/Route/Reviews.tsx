...
export const reviews = [
  {
    ...
    comment:
      "I had the pleasure of exploring SkillBridge, a website that provides an extensive range of courses on various tech-related topics. The courses cater to different skill levels and interests. Highly recommend!",
    rating: 5,
    tag: "Courses",
  },
  {
  ...
  },
  {
    ...
    comment:
      "I was thoroughly impressed with SkillBridge's course range. Highly practical and engaging content that pushed me to grow every single day.",
    rating: 5,
    tag: "Courses",
  },
  {
  ...
  },
  {
    ...
    comment:
      "SkillBridge focuses on practical applications. Lessons are clear, and projects are comprehensive. Highly recommended!",
    rating: 5,
    tag: "Practical",
  },
];
