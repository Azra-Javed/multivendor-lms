...
const Footer = (props: Props) => {
  return (
    <footer className="w-full border-t border-gray-200 dark:border-white/10 bg-white dark:bg-slate-900 mt-20">
      <div className="w-[95%] 800px:max-w-[85%] mx-auto px-2 sm:px-6 lg:px-8 py-14">
        {/* Top grid */}
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-4">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold tracking-widest uppercase text-gray-900 dark:text-white font-Poppins">
              About
            </h3>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              {[
                ...
                { label: "Chunian, Kasur, Punjab, Pakistan", href: "#" },
              ].map((item, i) => (
                <li key={i}>
                  <Link
                    href={item.href}
        ...
        {/* Divider */}
        <div className="h-px bg-gray-200 dark:bg-white/10 mt-12 mb-8" />
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4">
            <Link
              ...
              target="_blank"
              className="w-9 h-9 rounded-lg border border-gray-200 dark:border-white/10
